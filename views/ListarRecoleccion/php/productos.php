...
$pdf->Cell(70, 8, '', 0);
$pdf->Cell(100, 8, 'Reporte Actividades Recoleccion y transporte', 0);
$pdf->Ln(10);
$pdf->Cell(60, 8, '', 0);
...
$pdf->Cell(60, 8, 'Vehiculo', 1,0,'C');
$pdf->Cell(30, 8, 'Placa', 1,0,'C');
$pdf->Cell(30, 8, 'Barrio', 1,0,'C');


$pdf->Ln(8);
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysql_query("SELECT * FROM recoleccion WHERE fecha BETWEEN '$desde' AND '$hasta' ");
$item = 0;
$totaluni = 0;
$totaldis = 0;
while($productos2 = mysql_fetch_array($productos)){
	...
	$pdf->Cell(60, 8, $productos2['vehiculo'], 1,0,'C');
	$pdf->Cell(30, 8, $productos2['placa'], 1,0,'C');
	$pdf->Cell(30, 8, $productos2['barrio'], 1,0,'C');
...
$pdf->Output('ReporteActividadesRecoleccion.pdf','D');
?>