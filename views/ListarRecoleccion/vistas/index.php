...
if(!isset($_SESSION["user_id"]) >4){
    print "<script>alert(\"No tienes privilegis para listar!\");window.location='../../../Login.html';</script>";
}
?>
...
<title>Recolecion y Transporte</title>
...
<body background="../recursos/fondo.png">
    <header>Actividades de Recoleccion y Transporte
...
<center>
    <table border="0" align="center">
        <tr>
            ...
            <td width="335"><input type="text" placeholder="Buscar por  Vehiculo" id="bs-prod"/></td>
